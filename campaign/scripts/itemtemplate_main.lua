...
function update()
	...
	if updateControl("range", bReadOnly, bWeapon) then bSection3 = true; end
	if updateControl("capacity", bReadOnly, bWeapon) then bSection3 = true; end
	if updateControl("reload", bReadOnly, bWeapon) then bSection3 = true; end
